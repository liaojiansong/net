...
(function (factory) {
    ...
    (function (H) {
        ...
        if (!H.radialAxisExtended) {
             ...
             */
            wrap(tickProto, 'getPosition', function (proceed,
                                                     horiz,
                                                     pos,
                                                     tickmarkOffset,
                                                     old) {
             ...
             */
            wrap(tickProto, 'getLabelPosition', function (proceed,
                                                          x,
                                                          y,
                                                          label,
                                                          horiz,
             ...
             */
            wrap(tickProto, 'getMarkPath', function (proceed,
                                                     x,
                                                     y,
                                                     tickLength,
                                                     tickWidth,
    ...
    (function (H) {
        ...
        if (!H.polarExtended) {
            ...
            if (seriesTypes.column) {
                 ...
                 */
                wrap(colProto, 'alignDataLabel', function (proceed,
                                                           point,
                                                           dataLabel,
                                                           options,
                                                           alignTo,
