...
(function (factory) {
    ...
    (function (H) {
        ...
        H.initCanvasBoost = function () {
            ...
            seriesTypes.scatter.prototype.cvsMarkerCircle = function (ctx,
                                                                      clientX,
                                                                      plotY,
                                                                      r) {
                ctx.moveTo(clientX, plotY);
            ...
            seriesTypes.scatter.prototype.cvsMarkerSquare = function (ctx,
                                                                      clientX,
                                                                      plotY,
                                                                      r) {
            ...
            if (seriesTypes.bubble) {
                seriesTypes.bubble.prototype.cvsMarkerCircle = function (ctx,
                                                                         clientX,
                                                                         plotY,
                                                                         r,
                                                                         i) {
